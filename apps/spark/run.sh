...
################################Kmeans##################################################################
SECONDS=0
./bin/spark-submit --master spark://127.0.0.1:$c --master local[$2] --class org.apache.spark.examples.SparkKMeans examples/jars/spark-examples_2.11-2.0.2.jar "data//kmean/new.csv" 5 1 
duration=$SECONDS
echo $duration >> ../$3
########################################################################################################
...
#####################################PageRank###########################################################
SECONDS=0
./bin/spark-submit --master spark://127.0.0.1:$c --master local[$2] --class org.apache.spark.examples.SparkPageRank examples/jars/spark-examples_2.11-2.0.2.jar "data//pr/new.csv" 10
duration=$SECONDS
echo $duration >> ../$3
########################################################################################################
...
#################################Linear Regression######################################################
SECONDS=0
./bin/spark-submit --master spark://127.0.0.1:$c --master local[$2] --class org.apache.spark.examples.SparkHdfsLR examples/jars/spark-examples_2.11-2.0.2.jar "data//lr/new.csv" 10
duration=$SECONDS
echo $duration >> ../$3
######################################################################################################
