...
for i in 1 2 3 4 5
do
	{ time taskset -c 0-22 /home/$kvm1/parsec-3.0/parsec/benchmark/pbzip2-1.1.13/pbzip2 -1 -p$1 -m1 -b1 -rkvf /home//testA; } &>> $ctx_pbzip2/vm1.pbzip2 &
	{ time taskset -c 24-46 /home/$kvm2/parsec-3.0/parsec/benchmark/pbzip2-1.1.13/pbzip2 -1 -p$1 -m1 -b1 -rkvf /home//testA; } &>> $ctx_pbzip2/vm2.pbzip2
	sleep 30
done
...
for i in 1 2 3 4 5
do
	{ time taskset -c 0-22 /home/$kvm1/parsec-3.0/parsec/benchmark/pbzip2-1.1.13/pbzip2 -1 -p$1 -m1 -b1 -dkvf /home//testA.bz2; } &>> $ctx_pbzip2/vm1.pbzip2.de &
	{ time taskset -c 24-46 /home/$kvm2/parsec-3.0/parsec/benchmark/pbzip2-1.1.13/pbzip2 -1 -p$1 -m1 -b1 -dkvf /home//testA.bz2; } &>> $ctx_pbzip2/vm2.pbzip2.de
	sleep 30
done

#sockperf
#server side
SOCKPERF_DIR="/home//workshop/vMigrater/macro_benchmarks/bench6/net_perf/sockperf/sockperf-3.1"
