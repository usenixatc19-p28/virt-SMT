...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 /home/$kvm1/parsec-3.0/parsec/benchmark/pbzip2-1.1.13/pbzip2 -1 -p$1 -m1 -b1 -rkvf /home//testA; } &>> $ctx_pbzip2/vm1.pbzip2
...
for i in 1 2 3 4 5
do
	{ time taskset -c 24-46 /home/$kvm1/parsec-3.0/parsec/benchmark/pbzip2-1.1.13/pbzip2 -1 -p$1 -m1 -b1 -dkvf /home//testA.bz2; } &>> $ctx_pbzip2/vm1.pbzip2.de
